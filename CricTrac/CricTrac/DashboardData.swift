...
class DashboardData {
    ...
    init(dataObj: [String: AnyObject!]){
        ...
        self.TopBowling1stMatchScore = String(dataObj["TopBowling1stMatchScore"] ?? "0-9999")
        ...
        self.TopBowling2ndMatchScore = String(dataObj["TopBowling2ndMatchScore"] ?? "0-9999")
        ...
        self.TopBowling3rdMatchScore = String(dataObj["TopBowling3rdMatchScore"] ?? "0-9999")
    ...
    var dashboardData: [String: AnyObject] {
        ...
        "TopBatting2ndMatchDispScore" : self.TopBatting2ndMatchDispScore,
        "TopBatting3rdMatchDispScore" : self.TopBatting3rdMatchDispScore
        ]
    }

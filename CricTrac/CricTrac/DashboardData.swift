...
class DashboardData {
    ...
    init(dataObj: [String: AnyObject!]){
        ...
        self.TopBatting1stMatch = dataObj["TopBatting1stMatch"] ?? 0
        ...
        self.TopBatting2ndMatch = dataObj["TopBatting2ndMatch"] ?? 0
        ...
        self.TopBatting3rdMatch = dataObj["TopBatting3rdMatch"] ?? 0
